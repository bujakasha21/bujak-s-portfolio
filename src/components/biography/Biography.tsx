...
const Biography = () => {
  return (
    <div
      id="about-me"
      className="w-full min-h-screen pb-20 bg-secondaryCol overflow-hidden"
    >
      <SlideToRight>
          ...
          <div className="w-full flex flex-col sm:flex-row gap-y-10 sm:gap-y-0 items-center justify-between">
            ...
            <div className="flex flex-col justify-end w-full lg:w-1/2 xl:w-2/5">
              <p className="text-mainCol text-sm xl:text-2xl text-center sm:text-right font-medium pb-10 md:pb-16">
                ...
                the world of Ju-Jitsu, where I hold the esteemed title of World
                ...
                Each pursuit, whether it&apos;s coding or combat, fuels my
                passion for excellence and my relentless pursuit of mastery.
                Join me in this exciting blend of creativity, coding, and combat
                as I strive for excellence in every arena.
              </p>
