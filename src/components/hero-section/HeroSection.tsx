...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="relative w-full h-screen sm:h-[140vh] md:h-screen bg-mainCol overflow-hidden"
    >
      <div className="absolute inset-0 w-11/12 md:w-4/5 mt-[8rem] mb-8 lg:mt-[12rem] h-full mx-auto">
        <div className="flex flex-col justify-center items-center md:items-start gap-y-8 sm:gap-y-2 md:gap-y-20 w-full">
          <SlideToRight>
            <h4 className="text-xl font-bold md:text-4xl text-darkerCol">
              {`<Hello World />`}
            </h4>
          </SlideToRight>
          <h1 className="text-4xl text-center md:text-left font-bold md:text-8xl text-secondaryCol h-0 md:h-[5rem]">
          ...
          <SlideToTop>
            <div className="flex flex-col items-start justify-start pt-20 gap-y-14">
              <p className="text-center md:text-left text-md md:text-xl lg:text-2xl w-full md:w-3/5 text-secondaryCol font-medium pt-10 sm:pt-5">
