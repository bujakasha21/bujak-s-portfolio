...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="relative w-full min-h-screen sm:h-[70vw] lg:min-h-screen xl:h-[950px] bg-mainCol overflow-hidden"
    >
      <div className="absolute inset-0 w-11/12 md:w-4/5 mt-[8rem] mb-8 mx-auto">
        <div className="flex flex-col justify-center items-center md:items-start gap-y-8 sm:gap-y-2 md:gap-y-10 w-full h-full">
